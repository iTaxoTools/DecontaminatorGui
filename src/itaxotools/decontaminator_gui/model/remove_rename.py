...
from ..tasks import remove_rename
...
class RemoveRenameModel(TaskModel):
    task_name = 'Remove-Rename'

    input = Property(Path, None)

    def __init__(self, name=None):
        super().__init__(name)
        self.exec(Subtask.Initialize, remove_rename.initialize)
